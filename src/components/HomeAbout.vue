    ...
    return {
      ...
      tabs: [
        ...
        },
        {
          ...
          unit: "+",
          text: "Cơ sở dịch vụ",
          desc: "Với tầm nhìn trở thành tổ chức tài chính hàng đầu khu vực châu Á – Thái Bình Dương, trong đó Cathay Life Việt Nam đã có mặt trên thị trường được 17 năm (đính kèm link), với hơn 150 điểm kinh doanh trên toàn quốc.",
        },
        {
          id: "tab4",
          label: "Khách hàng là thượng đế",
          number: "20",
          unit: "+",
          text: "Giải thưởng quốc tế",
          desc: "Hằng năm vinh dự nhận hơn 20 giải thưởng trong và ngoài nước về dịch vụ khách hàng và trải nghiệm số, chúng tôi không ngừng nỗ lực mang đến trải nghiệm đáng tin cậy cho khách hàng trên cả môi trường trực tuyến lẫn trực tiếp.",
        },
      ],
    };
  },
